      ...
      <div className="card-body text-center">
        ...
        <div className="prose">
          ...
          <p className="text-sm text-neutral-500 mt-4">
            Note: Road transport booking implementation will be customized based
...
export default RoadTransportBooking;
