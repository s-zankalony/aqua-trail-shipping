...
export const countries: CountryType[] = [
  ...
  { name: 'Bonaire Sint Eustatius Saba', abbr: 'BQ' },
  ...
  { name: 'Congo', abbr: 'CG' },
  { name: 'Congo Democratic Republic', abbr: 'CD' },
  { name: 'Cook Islands', abbr: 'CK' },
  { name: 'Costa Rica', abbr: 'CR' },
  { name: 'Cote DIvoire', abbr: 'CI' },
  ...
  { name: 'Guyana', abbr: 'GY' },
  { name: 'Haiti', abbr: 'HT' },
  { name: 'Heard Island McDonald Islands', abbr: 'HM' },
  ...
  { name: 'Korea', abbr: 'KR' },
  { name: 'Korea Democratic Peoples Republic', abbr: 'KP' },
  { name: 'Kuwait', abbr: 'KW' },
  { name: 'Kyrgyzstan', abbr: 'KG' },
  { name: 'Lao Peoples Democratic Republic', abbr: 'LA' },
  { name: 'Latvia', abbr: 'LV' },
  ...
  { name: 'Palau', abbr: 'PW' },
  { name: 'Palestinian Territory', abbr: 'PS' },
  { name: 'Panama', abbr: 'PA' },
  ...
  { name: 'Saint Vincent And Grenadines', abbr: 'VC' },
  { name: 'Samoa', abbr: 'WS' },
  ...
  { name: 'South Georgia And Sandwich Isl', abbr: 'GS' },
